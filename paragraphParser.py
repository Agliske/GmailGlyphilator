...
def articleParse(url, method = 1, search_metadata = {"headless_browser":True}):
    ...
    if method == 1:
        ...
        def selenium_retrieval(url,result):
            ...
            if search_metadata["headless_browser"] == True:
        ...
        try:
            ...
            try:
                ...
                print("no html retrieved from source")
                return articleParse(url,method=3)
        except:
            return articleParse(url,method=3)
...
def txtFileParse(filepath):
    ...
    if filepath.endswith(".txt"):
        ...
        articleData["url"] = filepath#filepath
